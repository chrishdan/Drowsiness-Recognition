...
def main_loop():
    ...
    while True:
        ...
        # Here is code which finds the eyes and hightlight them on screen
        for face_landmarks in face_landmarks_list:
                
            # array containing points making up eyes
            ...
            # calling def eye_aspect_ratio on both eyes
            # This returns a value = EAR (eye aspect ratio) for each eye
            leftEAR = eye_aspect_ratio(leftEye)
            rightEAR = eye_aspect_ratio(rightEye)

            # MAR ( mouth aspect ratio) on mouth
            # MAR is how open the mouth is
            mar = mouth_aspect_ratio(topLip, bottomLip)

            # total EAR ( eye aspect ratio) on both eyes
            # EAR is how open the eyes are
